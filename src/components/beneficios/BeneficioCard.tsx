...
export function BeneficioCard({ beneficio }: { beneficio: Beneficio }) {
  return (
    <article className="flex flex-col gap-2 rounded-xl bg-white p-4 shadow-card">
      <div className="flex items-start justify-between gap-2">
        <div className="flex min-w-0 items-center gap-3">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-ivy-50 text-ivy-700">
            <span className="material-symbols-outlined text-[22px]">{RUBRO_ICON[beneficio.rubro]}</span>
          </div>
        ...
        <span className="shrink-0 rounded-full bg-cardinal-500 px-2.5 py-0.5 text-xs font-bold tracking-wide text-white shadow-sm">
          {beneficio.descuento}
        </span>
      </div>
